...
public class PlayerColourController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (phase == 0) {
            ...
            Trail2.startColor = new Color(0.0f, 0.0f, 1.0f, 0.2f);
        ...
        if (phase == 1) {
            ...
            Trail2.startColor = new Color(0.0f, 1.0f, 0.0f, 0.2f);
        ...
        if (phase == 2) {
            ...
            Trail2.startColor = new Color(1.0f, 0.0f, 0.0f, 0.2f);
        ...
        if (phase == 3) {
            ...
            Trail2.startColor = new Color(1.0f, 1.0f, 1.0f, 0.2f);
